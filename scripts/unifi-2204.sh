...
# Data de atualização: 18/08/2022
# Versão: 0.01
...
#
# Vídeo de instalação do GNU/Linux Ubuntu Server 22.04.x LTS: https://www.youtube.com/watch?v=zZf_uzGpod4&t
#
...
#
# Verificando se o usuário é Root e se a Distribuição é >= 22.04 <IF MELHORADO)
...
#
# Script de instalação do Unifi Controller no GNU/Linux Ubuntu Server 22.04.x
...
#
echo
echo -e "Instalação do Unifi Controller no GNU/Linux Ubuntu Server 22.04.x\n"
